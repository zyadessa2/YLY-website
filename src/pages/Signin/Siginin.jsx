  ...
  return <>
    ...
    <div className="login bg-dark  ">
        <div className="row vh-100 justify-content-center align-items-center">
          ...
          <h3 className='h1 pb-2 text-primary'>Sign up</h3>
                    ...
                    <label className='d-flex align-items-center justify-content-start' htmlFor="file">
                        ...
                        <span className='mt-2 ms-1'>Add image</span>
                    </label>
                    <button className='mt-3 mb-3 btn btn-primary w-100 text-white '>Sign up</button>
          </form>
          <p className='ps-4 pt-3 pb-1 fs-5 noaccount text-danger'>Have an account? <Link to='/login'>Sign in</Link></p>
          </div>
